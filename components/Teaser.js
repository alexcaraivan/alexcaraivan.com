      ...
      <div className="bg-white-half">
        <div className="pb-6 pt-16 container mx-auto">
          <div className="flex items-center justify-around">
            {blok.image1 && (
              <img src={blok.image1.filename} alt={blok.image1.alt} className="w-48 rounded-full" />
            )}
            <div>
            ...
            {blok.image && (
              <img src={blok.image.filename} alt={blok.image.alt} className="w-48 rounded-full" />
            )}
          </div>
        </div>
      </div>
