...
export default function Index() {
  const auth = useAuth();
  return (
    <div className="flex justify-center items-center h-screen dark:bg-gray-700 dark:text-white">
      <p className="p-4 sm:w-80 text-justify">
        But I must explain to you how all this mistaken idea of denouncing pleasure and praising
        pain was born and I will give you a complete account of the system, and expound the actual
        teachings of the great explorer of the truth, the master-builder of human{' '}
        <span onClick={() => auth.signinWithGoogle('/home')}>happiness</span>. No one rejects,
